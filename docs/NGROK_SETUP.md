...
## � Vapi Webhook Setup (Voice Call এর জন্য)

ngrok URL পাওয়ার পর:

1. যান: https://dashboard.vapi.ai
2. **Assistants** এ ক্লিক করুন এবং আপনার Assistant সিলেক্ট করুন।
3. **Model** বা **Functions** ট্যাবে যান।
4. **Server URL** ফিল্ডটি খুঁজুন।
5. সেখানে পেস্ট করুন:
   ```
   https://YOUR_NGROK_URL.ngrok-free.app/vapi/webhook
   ```
   *(শেষে `/vapi/webhook` থাকতে হবে)*
6. **Save** করুন।
